...
本演習では，千代田区を楽しく歩くことで千代田区をより知ってもらうことを目的とした iOS と Android に対応した千代田区散歩アプリ「ちよダッシュ!」を開発した. このアプリはGoogle Map 上に古地図や文学テキストや言語資料を配置し, 日本語日本文学の観点から近世·近代·現代を透か し見ることで江戸·東京圏を再構築することを目指した Web アプリ「江戸·東京 WebGIS」を基礎にしている．
}
